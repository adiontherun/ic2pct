...
const speakers = [
  ...
  },
  {
    ...
    organization:
      "Department of Information Technology & Computer Application, MMMUT, Gorakhpur, India",
  ...
  {
    name: "Dr. Arun Sharma",
    position: "Managing Director - Anveshan Foundation",
  ...
  {
    name: "Prof. Janakarajan Ramkumar",
    position: "Professor",
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center py-10 px-4 w-full">
        ...
        <p className="text-center text-gray-600 mb-8">
          IEEE 6th International Conference on Computing, Power, and
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      "/reshot-icon-user-ZXFJAEQURK.svg";
                  }}
                />
