    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl mb-6">
            2026 IEEE 6th International Conference on Computing, Power, and
            Communication Technologies
          </h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Join us for the premier conference bringing together researchers,
            academicians, and industry professionals to share cutting-edge
            research in computing and communication technologies.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              The 2026 IEEE 6th International Conference on Computing, Power,
              and Communication Technologies (IC2PCT-2026) is a premier forum
              for researchers, academicians, and industry professionals to
              present and discuss the most recent innovations, trends, and
              concerns in the field of computing, power, and communication
              technologies.
            </p>
            <p className="text-lg text-gray-600 mb-8">
              This conference provides an excellent opportunity for participants
              to learn about state-of-the-art research results and to discuss
              emerging areas of research. It also creates a platform for
              researchers to meet and discuss their ideas that will result in
              collaborative research in different areas.
            </p>
            ...
            <Card className="h-full">
              ...
              <CardContent>
                <ul className="space-y-2 text-gray-600 text-sm">
                  ...
                  <li>
                    • Renewable Energy Technologies (e.g., Solar, Wind, Hydro,
                    Biomass)
                  </li>
                  <li>
                  ...
                  <li>
                    • Modern Power Electronics, Drives and Control, Electric
                    Vehicles
                  </li>
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://www.galgotiasuniversity.edu.in/public/uploads/media/ZE6Pp0UjcqM3YePbTNhicYhR1rGh2DpcnSgKbFMH.webp')",
            opacity: 0.3,
          }}
        />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center justify-between">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Galgotias University is a leading private university in India,
                  established in 2011 and located in Greater Noida, Uttar
                  Pradesh. Known for its state-of-the-art infrastructure and
                  commitment to academic excellence, the university offers
                  world-class education across various disciplines.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  With over 20,000+ students from 50+ countries, Galgotias
                  University has established itself as a global education hub.
                  The university is equipped with modern laboratories, research
                  facilities, and industry partnerships that provide students
                  with hands-on experience and exposure to cutting-edge
                  technologies.
                </p>
                <p className="text-lg text-gray-700 mb-8">
                  The university's School of Computing Science & Engineering is
                  particularly renowned for its research contributions in areas
                  such as Artificial Intelligence, Machine Learning, IoT,
                  Cybersecurity, and Data Science - making it the perfect venue
                  for the 2026 IEEE 6th International Conference on Computing,
                  Power, and Communication Technologies (IC2PCT-2026).
                </p>
                <Button
                  asChild
                  size="lg"
