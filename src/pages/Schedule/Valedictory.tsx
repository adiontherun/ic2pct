...
const ValedictorySchedule = () => {
  const pdfUrl = "/Valedictory Schedule - IC2PCT2026 -May 17.pdf";
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="bg-blue-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-3">Valedictory Ceremony</h1>
          <p className="text-lg text-blue-200">
            IC2PCT-2026 — Valedictory Ceremony Schedule
          </p>
        </div>
      </div>
      ...
      <main className="flex-1 flex flex-col items-center py-10 px-4 w-full">
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl px-6 py-4 mb-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <span className="text-blue-900 font-semibold text-lg">
                Valedictory Ceremony — IC2PCT 2026
              </span>
            </div>
            <a
              href={pdfUrl}
          ...
          <div className="w-full rounded-xl overflow-hidden border-2 border-blue-200 shadow-lg" style={{ height: "80vh" }}>
            <iframe
              src={pdfUrl}
              title="Valedictory Ceremony Schedule - IC2PCT 2026"
...
export default ValedictorySchedule;
